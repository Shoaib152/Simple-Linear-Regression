...
This project uses a dataset containing Height and Weight values to train a Linear Regression model.
The goal is to predict weight when a user enters their height.

This is a beginner-friendly ML project that helps understand:
...
✔ Predicts weight from height
✔ User-friendly input/output
✔ Converts final weight prediction into kilograms
